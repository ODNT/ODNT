...
void ThreadGetMyExternalIP(void* parg)
{
    ...
    RenameThread("olddogsnewtricks-ext-ip");
...
void ThreadSocketHandler(void* parg)
{
    ...
    RenameThread("olddogsnewtricks-net");
...
void ThreadMapPort(void* parg)
{
    ...
    RenameThread("olddogsnewtricks-UPnP");
...
void ThreadMapPort2(void* parg)
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "olddogsnewtricks " + FormatFullVersion();
#ifndef UPNPDISCOVER_SUCCESS
        /* miniupnpc 1.5 */
...
void ThreadDNSAddressSeed(void* parg)
{
    ...
    RenameThread("olddogsnewtricks-dnsseed");
...
void ThreadDumpAddress(void* parg)
{
    ...
    RenameThread("olddogsnewtricks-adrdump");
...
void ThreadOpenConnections(void* parg)
{
    ...
    RenameThread("olddogsnewtricks-opencon");
...
void ThreadMessageHandler(void* parg)
{
    ...
    RenameThread("olddogsnewtricks-msghand");
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. olddogsnewtricks is probably already running."), addrBind.ToString().c_str());
        else
...
void StartNode(void* parg)
{
    ...
    RenameThread("olddogsnewtricks-start");
